...
@section('content')
    ...
    <div>
		...
		<div class="panel-body">
            ...
            <span type="text" id="ficha" name="ficha" class="form-control" placeholder="000" value=""> {{$paciente->ficha}}</span>
						</div>
					...
					<div class="row">
						<div class="form-group col-4">
							...
							<span type="date" id="data_nasc" name="data_nasc" class="form-control" > {{$paciente->data_nasc?$paciente->data_nasc->format("d/m/Y"):""}}
              </span></div>

						<div class="form-group  col-6">
							<label for="email">Email</label>
							<span type="email" id="email" name="email" class="form-control" placeholder="exemplo@gmail.com">{{$paciente->email}}
              </span></div>
            ...
            {{$paciente->cep}}
              ...
              {{$paciente->numero}}
				...
				<div class="form-group col-2">
					...
					<span type="text" id="complemento" name="complemento" class="form-control"	placeholder="Complemento">
	...
	<div class="panel panel-primary">
      ...
      <table class="table table-borded table-hover table-sm">
        <thead><tr><th>Telefone</th><th>Tipo</th><th>Contato</th></tr></thead>
        <tbody>
