...
<form role="form" action="{{route('pacientes.store')}}" autocomplete="off"
			...
			<div class="row">
				<div class="col-8">
					<div class="row">
						...
						<input type="text" value="{{$next_ficha}}" id="ficha" name="ficha" class="form-control" placeholder="000" value="">
						</div>
