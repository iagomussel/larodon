...
<form method="POST" action="{{route('dentistas.store')}}" role="form">
	...
	<div class="form-group">
		  ...
		  <input id="especializacao" name="especializacao" placeholder="Especialização" type="text" required="required" class="form-control">
	</div>
	...
	<section>
		...
		<div class="form-group">
			  ...
			  <input id="Email" name="email" placeholder="mail@gmail.com" type="text" required="required" class="form-control">
		</div>
		<div class="form-group">
