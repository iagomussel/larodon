      ...
      <div class="container">
        <div class="calendar-bar">
          <div class="input-group">
            ...
            <span type="text" class="form-control text-center">{{
        ...
        <div
          class="row"
          v-bind:style="{ height: horariosList().length * 25 + 'px' }"
        >
          <div class="col-1 p-0">
            ...
            <div class="events-container h-100">
              <div
                class="events-container-overlay w-100 text-center"
              ...
              <div
                class="events-container-overlay horarios_row text-center linha"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>
              Agendamento para <b>{{ formulario.dia }}</b> às
              <b>{{ formulario.hora }}</b>
            </p>
            ...
            <div class="form-group">
              ...
              <!--<select
                style="width:100%"
                v-select2="formulario.paciente_nome"
                v-model="formulario.paciente_nome"
                id="Paciente"
                name="Paciente"
                class="paciente_select form-control"
              >
              ...
              <vue-select
                ...
                class="vue-select1"
                name="select1"
                :options="select.pacientes"
                :model.sync="formulario.paciente_nome"
              >
              </vue-select>
            </div>
            <div class="form-group">
              ...
              <input
                v-model="formulario.paciente_telefone"
                id="telefone"
                name="telefone"
                class="form-control"
              />
            ...
            <div class="form-group">
              ...
              <select
                ...
                v-select2="formulario.procedimento"
                id="procedimento"
                name="procedimento"
                class="procedimentos_select form-control"
              ></select>
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              v-on:click="create_scheduler_entry"
            >
              Agendar
            </button>
          </div>
...
export default {
  ...
  methods: {
    ...
    create_scheduler_entry() {
      var self = this;
      this.$http.post(this.url_create, this.formulario).then((res) => {
        console.log(res);
